	...
	for (NSString *key in aRecord)
	{
		...
		if (attributeDescription)
		{
			...
			case NSInteger16AttributeType:
				[managedObject setValue:[NSNumber numberWithLongLong:[[aRecord objectForKey:key] longLongValue]] forKey:key];
				break;
			case NSDecimalAttributeType:
				[managedObject setValue:[NSDecimalNumber decimalNumberWithString:[aRecord objectForKey:key]] forKey:key];
				break;
            case NSBooleanAttributeType:
                [managedObject setValue:[NSNumber numberWithInt:[[aRecord objectForKey:key] intValue]] forKey:key];
                break;
            case NSDateAttributeType:
            {
                ...
                NSDate *date = [dateFormatter dateFromString:[aRecord objectForKey:key]];

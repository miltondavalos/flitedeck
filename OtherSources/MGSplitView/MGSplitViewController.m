...
//  The below line of code will fix the crash but it leaves masterViewController's views in disarray. Specifically it left masterViewController's navigationBar sized for the wrong orientation.
    ...
    /*	if (self.view.window != nil) {
        ...
        // Better solution is - 
        // Change self.view to [[UIApplication sharedApplication] keyWindow]
